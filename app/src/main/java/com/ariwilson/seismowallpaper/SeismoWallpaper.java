...
public class SeismoWallpaper extends WallpaperService {
  ...
  private class SeismoEngine extends Engine
    ...
    SeismoEngine(int period) {
      ...
      seconds_to_save_ = Integer.parseInt(preferences_.getString("seconds_to_save", "0"));
      Log.d("SeismoWAllpaper", "seconds_to_save:"+seconds_to_save_);
    ...
    public void onSharedPreferenceChanged(SharedPreferences preferences,
      ...
      } else if (key.equals("seconds_to_save")) {
        seconds_to_save_ = Integer.parseInt(preferences_.getString("seconds_to_save", "0"));
        view_thread_.setSecondsToDisplay(seconds_to_save_);
      }
      else {
