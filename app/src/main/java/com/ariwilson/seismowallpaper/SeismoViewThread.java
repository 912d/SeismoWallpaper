...
public class SeismoViewThread extends Thread {
  ...
  public SeismoViewThread(Context ctx, SurfaceHolder holder, boolean filter,
                          ...
                          int period, int seconds_to_display) {
    ...
    period_ = period;
    //TODO should move it to separate function?
    SECONDS_TO_DISPLAY  = seconds_to_display;
    SECONDS_TO_SAVE = SECONDS_TO_DISPLAY;
  }
  ...
  public void setSecondsToDisplay(int seconds_to_display) {
    SECONDS_TO_DISPLAY= seconds_to_display;
    SECONDS_TO_SAVE = SECONDS_TO_DISPLAY;
  }
